...
use Qoliber\DataPatchCreator\Model\ImagesSync\ImageSyncInterface;
use ReflectionClass;
use ZipArchive;
...
{
    /** @var string  */
    public const XPATH_NAMESPACE = 'qoliber_datapatchcreator/export/namespace';

    /** @var string  */
    public const XPATH_MODULE = 'qoliber_datapatchcreator/export/module';

    /** @var string  */
    public const XPATH_EXPORT_USE_TIMESTAMP = 'qoliber_datapatchcreator/export/timestamp';

    /** @var string  */
    public const XPATH_EXPORT_LOCAL_PATH = 'qoliber_datapatchcreator/export/local_path';

    /** @var string  */
    public const XPATH_CONFIG_IMAGE_SYNC_ENABLED = 'qoliber_datapatchcreator/images/sync';

    /** @var string  */
    public const XPATH_CONFIG_IMAGE_SYNC_MODEL = 'qoliber_datapatchcreator/images/sync_model';

    /** @var string  */
    public const XPATH_CONFIG_EXPORT_SWATCHES = 'qoliber_datapatchcreator/images/swatches';

    /** @var string  */
    public const XPATH_RULES_BEHAVIOR = 'qoliber_datapatchcreator/rules/behavior';

    /** @var string  */
    public const XPATH_RULES_DISABLE = 'qoliber_datapatchcreator/rules/active';
